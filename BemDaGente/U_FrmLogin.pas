...
begin
  ...
  begin
    ...
    NovaSenha2.Text := '';
    NovaSenha.SetFocus;
    WebApplication.CallBackResponse.AddJavaScriptToExecute(swalError('ATENÇÃO','Senhas digitadas não Conferem, tente novamente !'));
    Exit;
  end;
...
begin
  ...
  begin
    ...
    AddToInitProc(swalError('ATENÇÃO','Código de Verificação não Confere, tente novamente !'));
    Exit;
  end;
